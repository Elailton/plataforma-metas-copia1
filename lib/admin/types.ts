...
export interface AdminCourseStudent extends AdminStudent {
  manualStatus: "active" | "suspended" | "revoked" | null
  hotmartActiveCount: number
  hotmartSuspendedCount: number
  hotmartRevokedCount: number
  accessBlock: {
    reason: string
    blockedAt: string
